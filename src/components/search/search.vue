    ...
    <div>
      <div class="container" id="app">
        <div class="page-header">
          <h2 class=" text-center text-primary">小一搜题</h2>
        </div>
        <form action="">
    ...
    export default {
      ...
      data(){
          return{
            ...
            formPicsData: "",
            multiple: true,
            photo:"C:\\Users\\23267\\Pictures\\Saved Pictures\\question1.jpg",
            res:""
          }
      },
      ...
      methods:{
        ...
        addSomePeoplePicsForm: function () {
          ...
          this.$http.post("/uploadPics", this.formPicsData, config).then(res => {
            ...
            this.$http.post("/ocr", res.data).then(res => {
            this.res=res.data
            console.log(res.data)
            window.open("https://www.baidu.com/s?wd="+this.res);
          })
          }).catch(res => {
